...
class GUI:
    def __init__(self):
        ...
        self.game = None
        self.root = tk.Tk()
        self.root.geometry("1000x700")  # Aumentar el tamaño de la ventana para acomodar el panel lateral
        ...
        # Frame para mostrar los equipos ganadores en el lado derecho
        self.frameRight = tk.Frame(self.root, width=200, height=700, bg="lightgrey", borderwidth=2, relief="solid")
        self.frameRight.pack(side=tk.RIGHT, fill=tk.BOTH)
        ...
        # Text widget para mostrar los equipos ganadores en el lado derecho
        self.teams_text = tk.Text(self.frameRight, height=40, width=30)
        self.teams_text.pack(padx=5, pady=5)
    ...
    def show_groups(self):
        if self.game is not None:
            ...
            # Insertar los registros de ganadores en el widget de texto en el lateral derecho
            for record in self.game.champions_teams_with_scores:
                self.teams_text.insert(tk.END, record + "\n")
        else:
